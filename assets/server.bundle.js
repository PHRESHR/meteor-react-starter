...
/***/ function(module, exports, __webpack_require__) {
	...
	var _collectionsPosts = __webpack_require__(170);

	var _collectionsPosts2 = _interopRequireDefault(_collectionsPosts);

	var _fixtures = __webpack_require__(171);
	...
	if (!_collectionsPosts2['default'].find().fetch().length) {
	  (0, _fixtures.createPosts)();
	  (0, _fixtures.createUsers)();
	}

	console.log('\n\nRunning on server only');
	console.log('There are # posts:', _collectionsPosts2['default'].find().fetch().length);
...
/***/ function(module, exports) {
	...
	exports['default'] = new Mongo.Collection('posts');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _collectionsUsers = __webpack_require__(172);
	...
	function createPosts() {
	  ...
	  [1, 2, 3, 4].forEach(function (count) {
	    _collectionsPosts2['default'].insert({
